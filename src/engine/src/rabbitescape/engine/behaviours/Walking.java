...
//    }
    ...
    public State newState(BehaviourTools t, boolean triggered) {
        StateHandler chain = createStateChain(t);
        return chain.handle();
    }
    ...
    private StateHandler createStateChain(BehaviourTools t) {
        StateHandler flatGroundHandler = new FlatGroundHandler(t);
        StateHandler downSlopeHandler = new DownSlopeHandler(t, flatGroundHandler);
        StateHandler upSlopeHandler = new UpSlopeHandler(t, downSlopeHandler);

        return upSlopeHandler; // The first handler in the chain
    }
